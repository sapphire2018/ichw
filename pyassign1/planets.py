...
planets(mercury,"purple",60)
planets(venus,"orange",113.7)
planets(earth,"blue",157.9)
planets(mars,"red",240.0)
planets(jupiter,"green",400)
planets(saturn,"brown",600)
